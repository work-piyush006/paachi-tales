...
def create_app():
    ...
    error_map={400:"Error 400 — Bad request.",401:"Error 401 — Login required.",403:"Error 403 — Access denied.",404:"Error 404 — Product not found.",409:"Error 409 — Conflict.",413:"Error 413 — Media file too large.",422:"Error 422 — Invalid data.",500:"Error 500 — Internal server issue.",503:"Error 503 — Service unavailable."}
